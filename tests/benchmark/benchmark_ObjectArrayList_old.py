...
pyFastUtilList = ObjectArrayList(UNSORT_LIST)
...
def main():
    print(f"---Python list & ObjectArrayList Benchmark---")
    ...
    print(f"PyFastUtil ObjectArrayList sort time: {time_pyfastutil_sort * 1000:.2f} ms")
    ...
    print(f"PyFastUtil ObjectArrayList append time: {time_pyfastutil_append * 1000:.2f} ms")
    ...
    print(f"PyFastUtil ObjectArrayList insert time: {time_pyfastutil_insert * 1000:.2f} ms")
    ...
    print(f"PyFastUtil ObjectArrayList pop time: {time_pyfastutil_pop * 1000:.2f} ms")
    ...
    print(f"PyFastUtil ObjectArrayList remove time: {time_pyfastutil_remove * 1000:.2f} ms")
    ...
    print(f"PyFastUtil ObjectArrayList extend time: {time_pyfastutil_extend * 1000:.2f} ms")
